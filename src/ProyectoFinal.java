...
public class ProyectoFinal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Please enter an integer quantity.");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(InputTextBox, javax.swing.GroupLayout.PREFERRED_SIZE, 49, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(PushButton, javax.swing.GroupLayout.DEFAULT_SIZE, 68, Short.MAX_VALUE))
                .addGap(73, 73, 73)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txtQueue, javax.swing.GroupLayout.PREFERRED_SIZE, 59, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(txtDeque, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(66, 66, 66)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtPriorityQueue, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addComponent(btnEnqueuePrior, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(btnDequeuePiror, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
...
InputTextBox.setText("");
    ...
    private void PopButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PopButtonActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Popped element: " + poppedItem);
        updateTextArea();
    } catch (EmptyStackException e) {
        JOptionPane.showMessageDialog(null, "The stack is empty. No elements to pop.");
    }
    ...
    private void PeekButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PeekButtonActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Element at the top of the stack: " + topItem);
    } catch (EmptyStackException e) {
        JOptionPane.showMessageDialog(null, "The stack is empty. No elements to view.");
    }
    ...
    if (!cola.isEmpty()) {
        ...
        JOptionPane.showMessageDialog(null, "Element removed: " + elementoEliminado);

        // Actualizar la lista de elementos en la cola
        actualizarListaCola();
    } else {
        JOptionPane.showMessageDialog(null, "The queue is empty. No elements to remove.");
    }
    ...
    if (!bicola.isEmpty()) {
        ...
        // Mostrar un mensaje con el elemento eliminado
        JOptionPane.showMessageDialog(null, "Removed element from the start " + elementoEliminado);

        // Actualizar la lista de elementos en la bicola
        actualizarListaBicola();
    } else {
        JOptionPane.showMessageDialog(null, "The deque is empty. No elements to remove from the start.");
    }
    ...
    if (!bicola.isEmpty()) {
        ...
        // Mostrar un mensaje con el elemento eliminado
        JOptionPane.showMessageDialog(null, "Removed element from the end: " + elementoEliminado);

        // Actualizar la lista de elementos en la bicola
        actualizarListaBicola();
    } else {
        JOptionPane.showMessageDialog(null, "The deque is empty. No elements to remove from the end.");
    }
    ...
    try {
        ...
        JOptionPane.showMessageDialog(null, "Please enter a valid priority (integer number).");
    }
    ...
    if (!colaPrioridad.isEmpty()) {
        ...
        JOptionPane.showMessageDialog(null, "The priority queue is empty. No elements to remove.");
    }
...
private void actualizarListaColaPrioridad() {
    ...
    for (Map.Entry<Integer, Queue<String>> entry : colaPrioridad.entrySet()) {
        ...
        for (String elemento : elementos) {
            TextAreaPriorQueue.append(elemento + " - Priority: " + prioridad + "\n");
        }
    }
}
    ...
    txtBubble.append("Execution time of BubbleSort() method = " + stopwatch.stop() + " milisegundos.");
    arrayReset(array);
    ...
    stopwatch.stop();
    printArray(array, txtBinaryTree);
    txtBinaryTree.append("Execution time of Binary Tree Sort method = " + stopwatch.stop()+ " milisegundos");
    arrayReset(array);
    ...
    stopwatch.stop();
    printArray(array, txtBucket);
    txtBucket.append("Execution time of BucketSort() method = " + stopwatch.stop()+ " milisegundos");
    arrayReset(array);
    ...
    stopwatch.stop();
    printArray(array, txtCocktail);
    txtCocktail.append("Execution time of CocktailSort() method = " + stopwatch.stop()+ " milisegundos");
    arrayReset(array);
    ...
    stopwatch.stop();
    printArray(array, txtComb);
    txtComb.append("Execution time of CombSort() method = " + stopwatch.stop()+ " milisegundos");
    arrayReset(array);
    ...
    stopwatch.stop();
    printArray(array, txtCounting);
    txtCounting.append("Execution time of CountingSort() method = " + stopwatch.stop()+ " milisegundos");
    arrayReset(array);
    ...
    stopwatch.stop();
    printArray(array, txtGnome);
    txtGnome.append("Execution time of GnomeSort() method = " + stopwatch.stop()+ " milisegundos");
    arrayReset(array);
    ...
    stopwatch.stop();
    printArray(array, txtHeap);
    txtHeap.append("Execution time of HeapSort() method = " + stopwatch.stop()+ " milisegundos");
    arrayReset(array);
    ...
    stopwatch.stop();
    printArray(array, txtMerge);
    txtMerge.append("Execution time of MergeSort() method = " + stopwatch.stop()+ " milisegundos");
    arrayReset(array);
    ...
    stopwatch.stop();
    printArray(array, txtInsertion);
    txtInsertion.append("Execution time of InsertionSort() method = " + stopwatch.stop()+ " milisegundos");
    arrayReset(array);
    ...
    stopwatch.stop();
    printArray(array, txtPigeon);
    txtPigeon.append("Execution time of PigeonHoleSort() method = " + stopwatch.stop()+ " milisegundos");
    arrayReset(array);
    ...
    stopwatch.stop();
    printArray(array, txtQuick);
    txtQuick.append("Execution time of QuickSort() method = " + stopwatch.stop()+ " milisegundos");
    arrayReset(array);
    ...
    stopwatch.stop();
    printArray(array, txtRadix);
    txtRadix.append("Execution time of RadixSort() method = " + stopwatch.stop()+ " milisegundos");
    arrayReset(array);
    ...
    stopwatch.stop();
    printArray(array, txtSelection);
    txtSelection.append("Execution time of SelectionSort() method = " + stopwatch.stop()+ " milisegundos");
    arrayReset(array);
...
txtShell.append("\nSorted Array: ");
printArray(array, txtShell);
txtShell.append("Execution time of ShellSort() method = " + stopwatch.stop());
arrayReset(array);
...
stopwatch.reset();
txtSmooth.append("Initial Array: ");
printArray(array, txtSmooth);
stopwatch.start();
smoothSort.sort(array);
stopwatch.stop();
txtSmooth.append("Sorted Array: ");
printArray(array, txtSmooth);
txtSmooth.append("Execution time of SmoothSort() method = " + stopwatch.stop());
arrayReset(array);
    ...
    for (int i = 0; i < array.length - 1; i++) {
        for (int j = 0; j < array.length - i - 1; j++) {
            ...
            if (array[j] > array[j + 1]) {
                ...
                txtArea.append("Exchange - " + Arrays.toString(array) + "\n");
            }
        }
    }
    txtArea.append("Sorted Array: ");
    printArray(array, txtArea);
}
